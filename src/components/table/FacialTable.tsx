...
const FacialTable: FC<IfacialProps> = (props) => {
 ...
 const [selectedFacialId, setSelectedFacialId] = useState<number | null>(null);

 const sortFacials = facials.sort((a, b) => a.id - b.id);

 const handleDelete = async () => {
  try {
    if (selectedFacialId !== null) {
      await deleteFacial(selectedFacialId);
